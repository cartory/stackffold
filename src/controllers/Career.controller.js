...
let CareerController = class CareerController {
    findAll(res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(200).json(yield models_1.Career.findAll());
            }
            catch (err) {
                console.error(err);
            }
    ...
    findOne(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(200).json(yield models_1.Career.findOne({ where: { id } }));
            }
            catch (err) {
                console.error(err);
            }
    ...
    save(career, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(201).json((yield models_1.Career.upsert(career))[0]);
            }
            catch (err) {
                console.error(err);
            }
    ...
    destroy(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(202).send(yield models_1.Career.destroy({ where: { id } }));
            }
            catch (err) {
                console.error(err);
            }
...
__decorate([
    ...
    __param(1, (0, express_1.Response)())
], CareerController.prototype, "save", null);
__decorate([
    (0, express_1.Delete)('/:id'),
    __param(0, (0, express_1.Params)('id')),
    __param(1, (0, express_1.Response)())
], CareerController.prototype, "destroy", null);
CareerController = __decorate([
    (0, express_1.Controller)('/careers')
], CareerController);
